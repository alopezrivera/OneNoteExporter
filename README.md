...
`owo` (as in `o`ne`w`ay`o`ut of here, here being OneNote) is a PowerShell program to export all your OneNote notes to Emacs Org Mode or any other [Pandoc-supported markup](https://pandoc.org/) using the OneNote Object Model and Pandoc.
